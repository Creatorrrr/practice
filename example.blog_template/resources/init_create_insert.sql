...
insert into author_tb(id,password,name,email) values ('demonpark','111','박데몬','demonpark@nextree.co.kr');
insert into author_tb(id,password,name,email) values ('jhheo','111','허진호','jhheo@nextree.co.kr');
insert into author_tb(id,password,name,email) values ('syhan','111','한승용','syhan@nextree.co.kr');
insert into author_tb(id,password,name,email) values ('eykim','111','김은영','eykim@nextree.co.kr');
insert into author_tb(id,password,name,email) values ('kimgisa','111','김기사','hyunohkim@nextree.co.kr');

insert into blog_tb(id,title,author_id) values (blog_seq.NEXTVAL,'하늘바람별','demonpark');
insert into blog_tb(id,title,author_id) values (blog_seq.NEXTVAL,'보편적인블로그','eykim');
insert into blog_tb(id,title,author_id) values (blog_seq.NEXTVAL,'김기사의 iT스토리','kimgisa');
