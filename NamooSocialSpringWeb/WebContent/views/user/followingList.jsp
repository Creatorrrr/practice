...
<c:set var="thisPage" value="following" />
                ...
                <div class="tab-pane fade active in" id="all">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form action="${ctx }/user/following.do" method="post" class="form-search">
                            		...
                            		<c:otherwise>
                            			<c:forEach items="${users }" var="user" varStatus="status">
	                            			<tr>
			                                    ...
			                                    <td class="text-center"><a href="${ctx }/user/unfollow.do?toUserId=${user.id }">언팔로우</a></td>
			                                </tr>
                            			</c:forEach>
                            		</c:otherwise>
                            	</c:choose>
